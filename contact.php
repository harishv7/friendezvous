<?php include('includes/header-black.php') ?>
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <p></p>
                        <p>Contact us via
                            <a href="<?php echo $fbLink; ?>">Facebook</a>. Remember to like our page and support Friendezvous!</p>
                        <p></p>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <p></p>
                        <p>Contact us via
                            <a href="<?php echo $githubLink; ?>">Github</a>. Our project is hosted there, so feel free to take a look!</p>
                        <p></p>
                    </div>
                    <div class="col-md-6">
